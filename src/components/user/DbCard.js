            ...
            <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-4">
                    <div className="text-sm text-gray-600">
                        <span className="font-medium">{t('cards.username')}:</span> {database.username}
                    </div>
                    <p className="text-sm text-gray-500 mt-2">
                        {t('cards.createdAt')}: {new Date(database.createdAt).toLocaleDateString(locale === 'zh' ? 'zh-CN' : 'en-US')}
                    </p>
                </div>
